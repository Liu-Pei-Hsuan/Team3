...
plt.plot(age_0_4["case"], label = "0-4 歲", color = "darkorange")
plt.plot(age_5_14["case"], label = "5-14 歲", color = "forestgreen")
plt.plot(age_15_24["case"], label = "15-24 歲", color = "royalblue")
plt.plot(age_25_64["case"], label = "25-64 歲", color = "mediumpurple")
plt.plot(age_65["case"], label = "65 歲以上", color = "firebrick") #linestyle='-', marker = "o"
...
fig.savefig('app/static/influenza.png', bbox_inches="tight", pad_inches=0.1)
