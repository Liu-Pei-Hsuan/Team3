...
def get_data_save_to_csv(date,resource_id,totle):
    print(date+"..Start!")
...
#     soup = BeautifulSoup(res.text, features="html.parser")
    ...
    df_done.to_csv("AQI_DATA/" + date_change + "_空氣品質指標(AQI)_out.csv",encoding="utf-8-sig")
    print(date+"..Done!")
...
#     print(get_totol(resource_id))
    get_data_save_to_csv(data_in,resource_id,totle)